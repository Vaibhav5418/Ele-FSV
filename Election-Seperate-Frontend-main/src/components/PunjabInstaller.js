...
import { getAcdetails, getCamera, getCameraByDid, getCamerasByNumber, getDistrictDetails, getSetting, installCamera, setSetting, updateCamera } from '../actions/userActions';
...
export default withAuth(PunjabInstaller);
